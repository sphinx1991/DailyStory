...
public class ApiEndPoint {
	...
	public static final String ENDPOINT_TOP_NYT = "top-headlines?sources=the-new-york-times&apiKey="+BuildConfig.API_KEY;

	public static final String ENDPOINT_RECENT_NYT = "everything?sources=the-new-york-times&apiKey="+BuildConfig.API_KEY;

	public static final String ENDPOINT_TOP_CNN = "top-headlines?sources=cnn&apiKey="+BuildConfig.API_KEY;

	public static final String ENDPOINT_RECENT_CNN = "everything?sources=cnn&apiKey="+BuildConfig.API_KEY;

	public static final String ENDPOINT_TOP_BBC = "top-headlines?sources=bbc-news&apiKey="+BuildConfig.API_KEY;
